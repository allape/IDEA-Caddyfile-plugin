...
public class CaddyfileMatchDeclareTwoSepImpl extends ASTWrapperPsiElement implements CaddyfileMatchDeclareTwoSep {

  public CaddyfileMatchDeclareTwoSepImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitMatchDeclareTwoSep(this);
  }
