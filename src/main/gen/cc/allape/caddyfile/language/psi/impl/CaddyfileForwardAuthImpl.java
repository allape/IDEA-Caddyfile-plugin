...
public class CaddyfileForwardAuthImpl extends ASTWrapperPsiElement implements CaddyfileForwardAuth {

  public CaddyfileForwardAuthImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitForwardAuth(this);
  }
  ...
  @Override
  @NotNull
  public List<CaddyfileForwardAuthArg> getForwardAuthArgList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CaddyfileForwardAuthArg.class);
  }
