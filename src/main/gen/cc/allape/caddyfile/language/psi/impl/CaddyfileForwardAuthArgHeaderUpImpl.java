...
public class CaddyfileForwardAuthArgHeaderUpImpl extends ASTWrapperPsiElement implements CaddyfileForwardAuthArgHeaderUp {

  public CaddyfileForwardAuthArgHeaderUpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitForwardAuthArgHeaderUp(this);
  }
  ...
  @Override
  @Nullable
  public CaddyfileVariable getVariable() {
    return findChildByClass(CaddyfileVariable.class);
  }
