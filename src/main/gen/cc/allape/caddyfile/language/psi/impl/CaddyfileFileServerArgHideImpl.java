...
public class CaddyfileFileServerArgHideImpl extends ASTWrapperPsiElement implements CaddyfileFileServerArgHide {

  public CaddyfileFileServerArgHideImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitFileServerArgHide(this);
  }
