...
public class CaddyfileMatcherThrImpl extends ASTWrapperPsiElement implements CaddyfileMatcherThr {

  public CaddyfileMatcherThrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitMatcherThr(this);
  }
