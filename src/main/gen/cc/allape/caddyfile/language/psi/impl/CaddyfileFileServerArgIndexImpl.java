...
public class CaddyfileFileServerArgIndexImpl extends ASTWrapperPsiElement implements CaddyfileFileServerArgIndex {

  public CaddyfileFileServerArgIndexImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitFileServerArgIndex(this);
  }
