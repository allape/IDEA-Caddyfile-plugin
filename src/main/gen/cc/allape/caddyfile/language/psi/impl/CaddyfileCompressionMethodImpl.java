...
public class CaddyfileCompressionMethodImpl extends ASTWrapperPsiElement implements CaddyfileCompressionMethod {

  public CaddyfileCompressionMethodImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitCompressionMethod(this);
  }
