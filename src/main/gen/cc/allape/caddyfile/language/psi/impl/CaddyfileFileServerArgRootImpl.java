...
public class CaddyfileFileServerArgRootImpl extends ASTWrapperPsiElement implements CaddyfileFileServerArgRoot {

  public CaddyfileFileServerArgRootImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitFileServerArgRoot(this);
  }
