...
public class CaddyfileFileServerArgFsImpl extends ASTWrapperPsiElement implements CaddyfileFileServerArgFs {

  public CaddyfileFileServerArgFsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitFileServerArgFs(this);
  }
