...
public class CaddyfileEncodeArgZstdImpl extends ASTWrapperPsiElement implements CaddyfileEncodeArgZstd {

  public CaddyfileEncodeArgZstdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitEncodeArgZstd(this);
  }
