...
public class CaddyfileForwardAuthArgUriImpl extends ASTWrapperPsiElement implements CaddyfileForwardAuthArgUri {

  public CaddyfileForwardAuthArgUriImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitForwardAuthArgUri(this);
  }
