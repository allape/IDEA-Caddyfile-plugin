...
public class CaddyfileEncodeArgMinimumLengthImpl extends ASTWrapperPsiElement implements CaddyfileEncodeArgMinimumLength {

  public CaddyfileEncodeArgMinimumLengthImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitEncodeArgMinimumLength(this);
  }
