...
public class CaddyfileFileServerArgStatusImpl extends ASTWrapperPsiElement implements CaddyfileFileServerArgStatus {

  public CaddyfileFileServerArgStatusImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitFileServerArgStatus(this);
  }
