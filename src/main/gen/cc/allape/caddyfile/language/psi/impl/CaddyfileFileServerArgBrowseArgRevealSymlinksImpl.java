...
public class CaddyfileFileServerArgBrowseArgRevealSymlinksImpl extends ASTWrapperPsiElement implements CaddyfileFileServerArgBrowseArgRevealSymlinks {

  public CaddyfileFileServerArgBrowseArgRevealSymlinksImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitFileServerArgBrowseArgRevealSymlinks(this);
  }
