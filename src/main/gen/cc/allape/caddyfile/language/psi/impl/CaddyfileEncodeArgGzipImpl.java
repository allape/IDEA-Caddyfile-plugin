...
public class CaddyfileEncodeArgGzipImpl extends ASTWrapperPsiElement implements CaddyfileEncodeArgGzip {

  public CaddyfileEncodeArgGzipImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitEncodeArgGzip(this);
  }
