...
public class CaddyfileReverseProxyImpl extends ASTWrapperPsiElement implements CaddyfileReverseProxy {

  public CaddyfileReverseProxyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitReverseProxy(this);
  }
  ...
  public CaddyfileHost getHost() {
    return findNotNullChildByClass(CaddyfileHost.class);
  }
