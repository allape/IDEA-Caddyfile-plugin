...
public class CaddyfileMatcherOneImpl extends ASTWrapperPsiElement implements CaddyfileMatcherOne {

  public CaddyfileMatcherOneImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitMatcherOne(this);
  }
