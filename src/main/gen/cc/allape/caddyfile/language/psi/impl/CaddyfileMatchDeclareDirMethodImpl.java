...
public class CaddyfileMatchDeclareDirMethodImpl extends ASTWrapperPsiElement implements CaddyfileMatchDeclareDirMethod {

  public CaddyfileMatchDeclareDirMethodImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitMatchDeclareDirMethod(this);
  }
