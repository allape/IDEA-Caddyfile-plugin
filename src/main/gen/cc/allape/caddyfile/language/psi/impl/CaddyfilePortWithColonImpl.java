...
public class CaddyfilePortWithColonImpl extends ASTWrapperPsiElement implements CaddyfilePortWithColon {

  public CaddyfilePortWithColonImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitPortWithColon(this);
  }
  ...
  @Override
  @NotNull
  public CaddyfileColon getColon() {
    return findNotNullChildByClass(CaddyfileColon.class);
  }
