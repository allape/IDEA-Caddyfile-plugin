...
public class CaddyfileFileServerArgDisableCanonicalUrisImpl extends ASTWrapperPsiElement implements CaddyfileFileServerArgDisableCanonicalUris {

  public CaddyfileFileServerArgDisableCanonicalUrisImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitFileServerArgDisableCanonicalUris(this);
  }
