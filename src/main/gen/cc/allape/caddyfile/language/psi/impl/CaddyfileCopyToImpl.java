...
public class CaddyfileCopyToImpl extends ASTWrapperPsiElement implements CaddyfileCopyTo {

  public CaddyfileCopyToImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CaddyfileVisitor visitor) {
    visitor.visitCopyTo(this);
  }
